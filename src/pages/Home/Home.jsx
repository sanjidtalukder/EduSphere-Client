...
const Home = () => {
 ...
 <section className="relative z-10 border border-blue-100 shadow-2xl py-14 px-6 sm:px-12 rounded-3xl text-center">
          ...
          {/* 🌟 Featured Articles */}
          <section>
            <h2 className="text-2xl font-bold mb-6 text-blue-900 text-center">📚 Featured Articles</h2>
          ...
          {/* 📂 Categories */}
          <section>
            <h2 className="text-2xl font-bold mb-6 text-blue-900 text-center">📂 Browse by Category</h2>
            {categories.length > 0 ? (
