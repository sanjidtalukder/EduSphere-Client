...
const MyArticles = () => {
  ...
  const fetchArticles = async () => {
    try {
      setLoading(true);
      const res = await axios.get(`https://my-edu-sphere-server-ten.vercel.app/articles?author_id=${user.uid}`);
      ...
      (t) => (
        <div className="flex flex-col space-y-2">
          ...
          <div className="flex justify-end space-x-2">
            <button
              onClick={() => {
                axios.delete(`https://my-edu-sphere-server-ten.vercel.app/articles/${id}`)
                  .then(() => {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      await axios.put(`https://my-edu-sphere-server-ten.vercel.app/articles/${_id}`, updatedArticle);
